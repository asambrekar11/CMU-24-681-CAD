...
/*static*/ PolyCreAboutDialog *PolyCreAboutDialog::Create(class GeblGuiEditorBase *canvas)
{
	PolyCreAboutDialog *dlg=new PolyCreAboutDialog;
	dlg->canvas=canvas;
	return dlg;
}

/*static*/ void PolyCreAboutDialog::Delete(PolyCreAboutDialog *ptr)
{
	delete ptr;
}
...
/* static */ void GeblGuiEditorBase::Help_About(void *appPtr,FsGuiPopUpMenu *,FsGuiPopUpMenuItem *)
{
	auto &canvas=*(GeblGuiEditorBase *)appPtr;
	canvas.aboutDlg->Make();
	canvas.AttachModalDialog(canvas.aboutDlg);
...
/* static */ PolyCreHelpDialog *PolyCreHelpDialog::Create(class GeblGuiEditorBase *canvas)
{
	auto *dlg=new PolyCreHelpDialog;
	dlg->canvas=canvas;
	return dlg;
}

/* static */ void PolyCreHelpDialog::Delete(PolyCreHelpDialog *ptr)
{
	delete ptr;
}

YSRESULT PolyCreHelpDialog::Make(void)
{
	if(NULL==okBtn)
	{
...
/* static */ void GeblGuiEditorBase::Help_Help(void *appPtr,FsGuiPopUpMenu *,FsGuiPopUpMenuItem *)
{
	auto &canvas=*(GeblGuiEditorBase *)appPtr;
	canvas.helpDlg->Make();
	canvas.AttachModalDialog(canvas.helpDlg);
	canvas.ArrangeDialog();
}

...
void (WINAPI *glGenBuffersPtr)(GLsizei n,const GLuint *buffers)=NULL;
...
void glGenBuffers(GLsizei n,const GLuint *buffers)
{
	...
	{
		glGenBuffersPtr=(void (WINAPI *)(GLsizei,const GLuint *))wglGetProcAddress("glGenBuffers");
	}
	if(NULL!=glGenBuffersPtr)
	{
...
void (WINAPI *glDeleteFramebuffersPtr)(GLsizei n,GLuint *buffers)=NULL;
...
void glDeleteFramebuffers(GLsizei n,const GLuint *framebuffers)
{
	...
	{
		glDeleteFramebuffersPtr=(void (WINAPI *)(GLsizei,GLuint *))wglGetProcAddress("glDeleteFramebuffers");
	}
	if(NULL!=glDeleteFramebuffersPtr)
	{
...
void (WINAPI *glShaderSourcePtr)(GLuint shader,  GLsizei count,  const GLchar **string,  const GLint *length)=NULL;
...
void glShaderSource(GLuint shader,GLsizei count,const GLchar **string,const GLint *length)
{
	...
	{
		glShaderSourcePtr=(void (WINAPI *)(GLuint,GLsizei,const GLchar **,const GLint *))wglGetProcAddress(funcStr);
	}
	if(NULL!=glShaderSourcePtr)
	{

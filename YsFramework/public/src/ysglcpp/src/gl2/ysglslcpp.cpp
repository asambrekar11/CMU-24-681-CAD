...
void YsGLSLRenderer::SetUniformShadowMapMode(int shadowMapMode)
{
	if(nullptr!=renderer3dPtr)
	{
		YsGLSLSet3DRendererUniformShadowMapMode(renderer3dPtr,shadowMapMode);
	}
}
void YsGLSLRenderer::SetUniformShadowMapTexture(int texIdent)
{
	if(nullptr!=renderer3dPtr)
	{
		YsGLSLSet3DRendererUniformShadowMapTexture(renderer3dPtr,texIdent);
	}
}
void YsGLSLRenderer::SetUniformShadowMapTransformation(const float lightTfm[16])
{
	if(nullptr!=renderer3dPtr)
	{
		YsGLSLSet3DRendererUniformShadowMapTransformation(renderer3dPtr,lightTfm);
	}
}

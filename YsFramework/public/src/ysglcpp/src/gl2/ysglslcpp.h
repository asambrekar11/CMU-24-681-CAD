...
public:
	...
	*/
	...
	void SetUniformShadowMapMode(int shadowMapMode);
	void SetUniformShadowMapTexture(int texIdent);
	void SetUniformShadowMapTransformation(const float lightTfmCache[16]);
